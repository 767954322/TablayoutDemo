...
import com.homechart.app.tablayoutdemo.twostyle.TwoFragment1;
import com.homechart.app.tablayoutdemo.twostyle.TwoFragment2;
import com.homechart.app.tablayoutdemo.twostyle.TwoFragment3;
 ...
 * app:tl_indicator_width="10dp"                  ----滚动条的固定宽度
 ...
 */
public class ThreeStyleActivity extends AppCompatActivity {
...
//        mTabLayout.setTextsize(15f);
    ...
    private void initFragment() {
        mFragmentsList.add(new ThreeFragment1());
        mFragmentsList.add(new ThreeFragment2());
        mFragmentsList.add(new ThreeFragment3());
    }
}
